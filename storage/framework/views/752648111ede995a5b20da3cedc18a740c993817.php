...
<html>
   ...
   <body>
      <div class="content">
         <h1 class="text-color"><?php echo "http://" . $_SERVER['SERVER_NAME']."/"; ?></h1>
         ...
         <button onclick="loginpage('http://<?php echo $is_subdomain_exists['subdomain']; ?><?php echo '.'.$_SERVER['SERVER_NAME'];?>/admin/login');" class="btn p-font btn-border" >Log in to backend</button>
      </div>
   </body>
...
</html><?php /**PATH /var/www/tastyignitor/app/main/views/register/ready.blade.php ENDPATH**/ ?>